    ...
    <div>
      <header class="p-4 sm:px-6 lg:p-14 sm:py-6 sm:flex sm:items-end mx-auto">
        ...
        <div class="flex mt-6 sm:mt-0 gap-4 ml-auto text-neutral-content">
          <a
            class="tooltip"
            data-tip="Project Github"
            href="https://github.com/hay-kot/homebox"
            target="_blank"
          ...
          <a
            href="https://twitter.com/haybytes"
            class="tooltip"
            data-tip="Follow The Developer"
            target="_blank"
            aria-label="Follow The Developer"
          >
            <Icon name="mdi-twitter" class="h-8 w-8" />
          </a>
          <a
            href="https://discord.gg/tuncmNrE4z"
            class="tooltip"
          ...
          <a
            href="https://hay-kot.github.io/homebox/"
            class="tooltip"
            data-tip="Read The Docs"
            target="_blank"
